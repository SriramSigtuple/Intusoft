...
/*
    Versin: 42.15729.2019.1016

    For Microsoft dotNET Framework & dotNet Core

    We use P/Invoke to call into the INTUCAM45_3MP.dll API, the c# class Toupcam is a thin wrapper class to the native api of INTUCAM45_3MP.dll.
...
public class Vendor1 : IDisposable
{
...
#else
        private const string dll = "INTUCAM45_3MP.dll";
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = cc), Obsolete("Use Toupcam_EnumV2")]
    ...
    */
    ...
    private static Dictionary<int, Vendor1> _map = new Dictionary<int, Vendor1>();
    ...
    */
    ...
    /* get the version of this dll/so, which is: 42.15729.2019.1016 */
