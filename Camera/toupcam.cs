...
namespace INTUSOFT.Imaging
{
    ...
    {
        [DllImport("INTUCAM45_3MP.dll", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
    ...
    public class Vendor1 : IDisposable
    {
        [Flags]
        ...
        public enum eEVENT : uint
        {
            ...
            EVENT_AFFEEDBACK         = 0x0083, /* auto focus sensor board positon */
            EVENT_AFPOSITION         = 0x0084, /* auto focus information feedback */
        ...
        internal delegate void PTOUPCAM_DATA_CALLBACK_V3(IntPtr pData, IntPtr pInfo, bool bSnap, IntPtr pCallbackCtx);
        [UnmanagedFunctionPointerAttribute(CallingConvention.StdCall)]
        ...
        [DllImport("INTUCAM45_3MP.dll", ExactSpelling = true, CallingConvention = CallingConvention.StdCall), Obsolete("Use Toupcam_EnumV2")]
        ...
        [DllImport("INTUCAM45_3MP.dll", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("INTUCAM45_3MP.dll", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        private static extern int Toupcam_StartPushModeV3(SafeCamHandle h, PTOUPCAM_DATA_CALLBACK_V3 pDataCallback, IntPtr pDataCallbackCtx, PTOUPCAM_EVENT_CALLBACK pEventCallback, IntPtr pEventCallbackCtx);
        [DllImport("INTUCAM45_3MP.dll", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        ...
        */
        ...
        [DllImport("INTUCAM45_3MP.dll", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Toupcam_FfcExport(SafeCamHandle h, [MarshalAs(UnmanagedType.LPWStr)] string filepath);
        [DllImport("INTUCAM45_3MP.dll", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Toupcam_FfcImport(SafeCamHandle h, [MarshalAs(UnmanagedType.LPWStr)] string filepath);
        [DllImport("INTUCAM45_3MP.dll", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Toupcam_DfcExport(SafeCamHandle h, [MarshalAs(UnmanagedType.LPWStr)] string filepath);
        [DllImport("INTUCAM45_3MP.dll", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Toupcam_DfcImport(SafeCamHandle h, [MarshalAs(UnmanagedType.LPWStr)] string filepath);
        ...
        private PTOUPCAM_DATA_CALLBACK_V3       _pDataCallbackV3;
        ...
        private static void DataCallbackV3(IntPtr pData, IntPtr pInfo, bool bSnap, IntPtr pCallbackCtx)
        {
            ...
            if (gch != null)
            {
                Vendor1 pthis = gch.Target as Vendor1;
                if (pthis != null)
        ...
        /*
            the object of ToupCam must be obtained by static mothod Open or OpenByIndex, it cannot be obtained by obj = new ToupTek.ToupCam (The constructor is private on purpose)
        */
        private Vendor1(SafeCamHandle h)
        {
            _handle = h;
        ...
        /* get the version of this dll, which is: 38.14764.2019.0530 */
        ...
        */
        /*
            ...
            etc
        */
        public static Vendor1 OpenByIndex(uint index)
        {
        ...
        */
        ...
        public bool StartPushModeV3(DelegateDataCallbackV3 ddelegate, DelegateEventCallback edelegate)
        {
            ...
            _dEventCallback = edelegate;
            _pDataCallbackV3 = new PTOUPCAM_DATA_CALLBACK_V3(DataCallbackV3);
            _pEventCallback = new PTOUPCAM_EVENT_CALLBACK(EventCallback);
            return (Toupcam_StartPushModeV3(_handle, _pDataCallbackV3, GCHandle.ToIntPtr(_gchandle), _pEventCallback, GCHandle.ToIntPtr(_gchandle)) >= 0);
        }
